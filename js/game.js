...
function addItems() {
  ...
  createItem(475, 500, 'coin');
  createItem(225, 500, 'coin');
  createItem(550, 300, 'coin');
  createItem(500, 200, 'coin');
  createItem(400, 50, 'coin');
  createItem(20, 10, 'coin');
  createItem(70, 100, 'coin');
  createItem(50, 200, 'poison');
  createItem(750, 400, 'star');
  createItem(740, 170, 'poison');
  createItem(50, 300, 'coin');
  createItem(740, 550, 'poison');
}
...
function addPlatforms() {
  ...
  platforms.create(400, 100, 'platform2');
  platforms.create(0, 60, 'platform');
...
window.onload = function () {
  ...
  function preload() {
    ...
    //Load spritesheets
    game.load.spritesheet('player', 'img/chalkers.png', 48, 62);
